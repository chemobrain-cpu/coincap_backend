...
router.post("/auth/paymentmethod",verifyToken,addPaymentMethod)
...
router.post("/auth/cancelregisteration", [
    body("email")
        .trim()
        .not()
        .isEmpty()
